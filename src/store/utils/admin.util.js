...
const getAllUsers = (page) => URL + "/api/users/all/user?page=" + page
const getNewUsers = URL + "/api/users/all/user?&filters=new&limit=10&populate=roles"
...
const getAdmins = URL + "/api/users/all/superadmin"
