<template>
    <transition name="fade">
        <div
            ...
            <h1 class="block py-2 px-4 font-medium text-center text-gray-700 bg-gray-50">
                Notifications
            </h1>
            ...
            <main v-for="item in newNotifications">
                <router-link
                    to=""
                    class="flex py-3 px-4 hover:bg-gray-100 border-b border-gray-400/10">
...
const { newNotifications } = refs(recipeStore)
</script>
