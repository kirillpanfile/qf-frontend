<template>
    ...
    <li v-else-if="type === 'recipe'" class="py-3 sm:py-4 list-none cursor-pointer hover:bg-gray-100 entranceFromRight">
            ...
            <div class="py-4 grid grid-cols-12 gap-2">
                <div class="px-4 flex col-span-7 lg:col-span-4 xl:col-span-3">
                    ...
                    <div class="text-sm font-normal text-gray-500 ml-4">
                        ...
                        <div class="text-sm font-normal text-gray-500 text-ellipsis">{{ email }}</div>
                    </div>
                </div>
                <div class="px-4 hidden lg:block lg:col-span-4 xl:col-span-3">
                    <h1 class="text-base font-bold">{{ id }}</h1>
                </div>
                <div class="col-span-3 hidden xl:block px-4">
                    <h1 class="text-base font-bold">{{ roles }}</h1>
                </div>
